var isValid = function (s) {
   ...
   // so the string is valid, otherwise, there are unmatched o
};

// Solution from https://leetcode.com/problems/valid-parentheses/solutions/3399077/easy-solutions-in-java-python-and-c-look-at-once-with-exaplanation/
